...
import { useRemoveAdmin } from "../../lib/admin/remove-admin";
import { useAdminUsers } from "../../lib/admin/admin-users";
      ...
      <div ref={ref} className={divClasses}>
        <div className="w-[70%]">
          <p className="flex justify-center text-3xl py-4">
            권한 박탈 버튼을 눌러 유저에게 어드민 권한을 박탈하실 수 있습니다.
          </p>
          ...
          {data.map((item) => (
            ...
            >
              ...
              <div className="justify-self-end">
                <button
                  className="bg-red-500 text-white py-2 rounded-md hover:bg-red-600 transition cursor-pointer w-[6.5rem]"
